...
<?php if( !is_post_type_archive(['testimonials', 'results']) && !is_single()) : ?>
    <section class="banner ignore-lazy" style="background-image:url('<?php echo checkWebpCompatibility($bg_image); ?>');">
<?php else : ?>
...
<?php endif; ?>
    ...
    <?php } ?>
        <div class="columns">
            ...
            <div class="<?php echo is_single() ? 'column-full' : 'column-66'; ?> block">
                <?php if(is_single()) { ?>
                ...
                <?php if(is_single()) { ?>
                    ...
                    <p class="category">Category: <?php $cat = get_the_category(); echo $cat[0]->cat_name; ?></p>
                <?php } ?>
                <?php if(!is_single()) { ?>
                    <p class="cta"><?php the_field('call_to_action_text','options'); ?> </p>
                    <div class="main-contact">
