...
<style type="text/css">  
    ...
    header.scrolled { background:<?php echo "rgba(" . $r2 . ", " . $g2 . ", " . $b2 . ",1)"; ?> !important; }
    header #header-top #header-top_right #header-top_right_menu .menu li a { font-family: <?php echo $GLOBALS['font_paragraph']; ?>; }
    /* header #header-top #header-top_right #header-top_right_menu .menu li:hover a { color:#AED69E !important; } */
    ...
    .body-container ul li, .body-container ol li { font-family: <?php echo $GLOBALS['font_paragraph']; ?>; color:<?php echo $body_font_color; ?>; }
    ...
    .banner h1 { font-family: <?php echo $GLOBALS['font_H1']; ?> !important; color:<?php echo $body_font_color; ?> !important; }
    ...
    .sidebar-block .sidebar-header { text-transform: uppercase; color: white; background: <?php echo $color_primary_2; ?>; font-family: <?php echo $GLOBALS['font_paragraph']; ?>; }
    ...
    /* blog landing */
    .blog article { background: <?php echo $color_primary_2; ?>; }
    ...
    /* contact form */
    .page-template-page-contact .gform_wrapper { background: <?php echo $color_primary_2; ?>; }
    .page-template-page-contact .gform_wrapper input[type="submit"] { background: <?php echo $color_secondary_2; ?>; font-family: <?php echo $GLOBALS['font_paragraph']; ?>; }
    ...
    .page-template-page-landing ul.landing-box li { background: <?php echo $color_primary_2; ?>; }
    .page-template-page-landing ul.landing-box li .all-pages { background: <?php echo $color_secondary_2; ?>; }

    /* testimonials block */
    #testimonial { background: <?php echo $color_primary_2; ?>; }
    ...
    #pre-footer h2, #pre-footer h3, #pre-footer h4, #pre-footer p { color: #fff; }

    /* footer */
    .footer { background: #f7f7f7 !important; } 
    .footer p, .footer ul li a { color: <?php echo $body_font_color; ?> ;font-family: <?php echo $GLOBALS['font_paragraph']; ?>; }
